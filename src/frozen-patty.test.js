...
test('attr: href', (t) => {
	...
	t.deepEqual(new FrozenPatty('<a data-field="href:href"></a>').merge({}).toDOM().children[0].href, '');
	...
	t.deepEqual(new FrozenPatty('<a href="hoge" data-field="href:href"></a>').merge({ href: 123.1 }).toDOM().children[0].href, '123.1');
	t.deepEqual(new FrozenPatty('<a href="hoge" data-field="href:href"></a>').merge({ href: 0.1 }).toDOM().children[0].href, '0.1');
	t.deepEqual(new FrozenPatty('<a href="hoge" data-field="href:href"></a>').merge({ href: .1 }).toDOM().children[0].href, '0.1');
