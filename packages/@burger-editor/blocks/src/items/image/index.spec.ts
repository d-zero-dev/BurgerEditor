...
describe('imageItemSeed', () => {
	...
	describe('toEditorState関数', () => {
		test('pathの__org置換', () => {
			...
			const result = imageItemSeed.toEditorState?.(data, testConfig);
...
// TODO(react-ui-overhaul): 旧ItemEditorDialogに依存していたインタラクティブテストは
// Reactエディタに対するブラウザテストとしてテスト移行タスクで再実装する
