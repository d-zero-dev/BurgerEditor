...
<div data-bge=":style, :scale, :scale-type, :aspect-ratio" data-bge-scale="25" data-bge-scale-type="original" data-bge-aspect-ratio="revert" style="--css-width: 100px; --object-fit: cover; --aspect-ratio: revert">
	<figure>
...
`);
		...
		expect(finalData).toStrictEqual({
			...
			scale: 25,
			scaleType: 'container',
			style: '--css-width: 25cqi; --object-fit: cover; --aspect-ratio: revert;',
			target: null,
		});
	});
});
