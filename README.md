...
| [@burger-editor/frozen-patty](./packages/@burger-editor/frozen-patty/) | [![npm version](https://badge.fury.io/js/@burger-editor%2Ffrozen-patty.svg)](https://badge.fury.io/js/@burger-editor%2Ffrozen-patty) | Pure HTML to JSON converter that does not use a template engine. |
